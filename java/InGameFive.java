...
public class InGameFive extends ActionBarActivity implements View.OnLongClickListener {
    ...
    private ImageView piece1, piece2, piece3, piece4, piece5, piece6, piece7, piece8, piece9, piece10, clear, iv0, iv1, iv2, iv3, iv4, iv5, iv6, iv7, iv8, iv9, iv10, iv11, iv12, iv13, iv14, iv15, iv16, iv17, iv18, iv19, iv20, iv21, iv22, iv23, iv24;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_in_game_five);
        initialize();
        ...
        ((Puzzles) this.getApplication()).createFivePuzzles();
        puzzleList = ((Puzzles) this.getApplication()).getFivePuzzle();
        ...
        resetPieces();
        clear = (ImageView) findViewById(R.id.clear5);
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        iv24.getLocationOnScreen(positionArr);
        int right = positionArr[0] + iv24.getWidth();
        int bottom = positionArr[1] + iv24.getHeight();

        int width = right-left;
        int height = bottom-top;

        iv14.getLocationOnScreen(positionArr);
        int arrowLeft = positionArr[0];
        int arrowTop = positionArr[1];
        int arrowRight = iv14.getWidth() + arrowLeft;
        int arrowBottom = iv14.getWidth() + arrowTop;

        iv24.getLocationOnScreen(positionArr);
        int menuLeft = positionArr[0];
        int menuTop = positionArr[1];
        int menuRight = iv24.getWidth() + menuLeft;
        int menuBottom = iv24.getWidth() + menuTop;
        ...
        if (keepGoing) {
            if (action == MotionEvent.ACTION_DOWN || action == MotionEvent.ACTION_MOVE) {
                ...
                if (done) {
                    ...
                    int prefsLevel = prefs.getInt(getApplicationContext(), SharedPrefs.SharedKeys.five);
                    if (levelNumInteger > prefsLevel) {
                        prefs.storeInt(getApplicationContext(), SharedPrefs.SharedKeys.five, levelNumInteger);
                    }
                        ...
                        public void run() {
                            if (count < 14) {
                                ...
                                if (count == 1) {
                                    ...
                                    ivList.get(10).setImageResource(R.drawable.n);
                                } else if (count == 6) {
                                    ivList.get(11).setImageResource(R.drawable.e);
                                } else if (count == 7) {
                                    ivList.get(12).setImageResource(R.drawable.x);
                                } else if (count == 8) {
                                    ivList.get(13).setImageResource(R.drawable.t);
                                } else if (count == 9) {
                                    ivList.get(14).setImageResource(R.drawable.arrow);
                                } else if (count == 10) {
                                    ivList.get(20).setImageResource(R.drawable.m);
                                } else if (count == 11) {
                                    ivList.get(21).setImageResource(R.drawable.e);
                                } else if (count == 12) {
                                    ivList.get(22).setImageResource(R.drawable.n);
                                } else if (count == 13) {
                                    ivList.get(23).setImageResource(R.drawable.u);
                                } else if (count == 14) {
                                    ivList.get(24).setImageResource(R.drawable.menu);
                                }
                            }
            ...
            if (action == MotionEvent.ACTION_DOWN) {
                if ((x >= arrowLeft && x <= arrowRight) && (y >= arrowTop && y <= arrowBottom)) {
                    arrowOnPoint = true;
                    ivList.get(14).setImageResource(R.drawable.arrowyellow);
                } else if ((x >= menuLeft && x <= menuRight) && (y >= menuTop && y <= menuBottom)) {
                    menuOnPoint = true;
                    ivList.get(24).setImageResource(R.drawable.menuyellow);
                }
            } else if (action == MotionEvent.ACTION_UP) {
                ivList.get(14).setImageResource(R.drawable.arrow);
                ivList.get(24).setImageResource(R.drawable.menu);
    ...
    public boolean check2l(int cornerIndex) {
        if (indexes.size() == 5) {
            for (int i = 0; i < indexes.size(); i++) {
                if (indexes.get(i) != cornerIndex && indexes.get(i) != cornerIndex - 1 && indexes.get(i) != cornerIndex - 6 && indexes.get(i) != cornerIndex - 7 && indexes.get(i) != cornerIndex - 12) {
                    return false;
                }
            }
        } else if (indexes.size() == 9) {
            for (int i = 0; i < indexes.size(); i++) {
                if (indexes.get(i) != cornerIndex && indexes.get(i) != cornerIndex - 1 && indexes.get(i) != cornerIndex - 2 && indexes.get(i) != cornerIndex - 7 && indexes.get(i) != cornerIndex - 12 && indexes.get(i) != cornerIndex - 13 && indexes.get(i) != cornerIndex - 14 && indexes.get(i) != cornerIndex - 19 && indexes.get(i) != cornerIndex - 24) {
                    return false;
                }
            }
        } else {
    ...
    public boolean checkCornerLeft(int cornerIndex) {
        if (indexes.size() == 3) {
            for (int i = 0; i < indexes.size(); i++) {
                if (indexes.get(i) != cornerIndex && indexes.get(i) != cornerIndex - 5 && indexes.get(i) != cornerIndex - 4) {
                    return false;
                }
            }
        } else if (indexes.size() == 5) {
            for (int i = 0; i < indexes.size(); i++) {
                if (indexes.get(i) != cornerIndex && indexes.get(i) != cornerIndex - 5 && indexes.get(i) != cornerIndex - 10 && indexes.get(i) != cornerIndex - 9 && indexes.get(i) != cornerIndex - 8) {
                    return false;
                }
            }
        } else if (indexes.size() == 7) {
            for (int i = 0; i < indexes.size(); i++) {
                if (indexes.get(i) != cornerIndex && indexes.get(i) != cornerIndex - 5 && indexes.get(i) != cornerIndex - 10 && indexes.get(i) != cornerIndex - 15 && indexes.get(i) != cornerIndex - 14 && indexes.get(i) != cornerIndex - 13 && indexes.get(i) != cornerIndex - 12) {
                    return false;
                }
            }
        } else if (indexes.size() == 9) {
            for (int i = 0; i < indexes.size(); i++) {
                if (indexes.get(i) != cornerIndex && indexes.get(i) != cornerIndex - 5 && indexes.get(i) != cornerIndex - 10 && indexes.get(i) != cornerIndex - 15 && indexes.get(i) != cornerIndex - 20 && indexes.get(i) != cornerIndex - 17 && indexes.get(i) != cornerIndex - 16 && indexes.get(i) != cornerIndex - 19 && indexes.get(i) != cornerIndex - 18) {
                    return false;
                }
            }
        } else {
    ...
    public boolean checkCornerRight(int cornerIndex) {
        if (indexes.size() == 3) {
            for (int i = 0; i < indexes.size(); i++) {
                if (indexes.get(i) != cornerIndex && indexes.get(i) != cornerIndex - 5 && indexes.get(i) != cornerIndex - 6) {
                    return false;
                }
            }
        } else if (indexes.size() == 5) {
            for (int i = 0; i < indexes.size(); i++) {
                if (indexes.get(i) != cornerIndex && indexes.get(i) != cornerIndex - 5 && indexes.get(i) != cornerIndex - 10 && indexes.get(i) != cornerIndex - 11 && indexes.get(i) != cornerIndex - 12) {
                    return false;
                }
            }
        } else if (indexes.size() == 7) {
            for (int i = 0; i < indexes.size(); i++) {
                if (indexes.get(i) != cornerIndex && indexes.get(i) != cornerIndex - 5 && indexes.get(i) != cornerIndex - 10 && indexes.get(i) != cornerIndex - 15 && indexes.get(i) != cornerIndex - 16 && indexes.get(i) != cornerIndex - 17 && indexes.get(i) != cornerIndex - 18) {
                    return false;
                }
            }
        } else if (indexes.size() == 9) {
            for (int i = 0; i < indexes.size(); i++) {
                if (indexes.get(i) != cornerIndex && indexes.get(i) != cornerIndex - 5 && indexes.get(i) != cornerIndex - 10 && indexes.get(i) != cornerIndex - 15 && indexes.get(i) != cornerIndex - 20 && indexes.get(i) != cornerIndex - 21 && indexes.get(i) != cornerIndex - 22 && indexes.get(i) != cornerIndex - 23 && indexes.get(i) != cornerIndex - 24) {
                    return false;
                }
            }
        } else {
    ...
    public boolean checkFlip2l(int cornerIndex) {
        if (indexes.size() == 5) {
            for (int i = 0; i < indexes.size(); i++) {
                if (indexes.get(i) != cornerIndex && indexes.get(i) != cornerIndex - 5 && indexes.get(i) != cornerIndex - 4 && indexes.get(i) != cornerIndex - 9 && indexes.get(i) != cornerIndex - 8) {
                    return false;
                }
            }
        } else if (indexes.size() == 9) {
            for (int i = 0; i < indexes.size(); i++) {
                if (indexes.get(i) != cornerIndex && indexes.get(i) != cornerIndex - 5 && indexes.get(i) != cornerIndex - 10 && indexes.get(i) != cornerIndex - 9 && indexes.get(i) != cornerIndex - 8 && indexes.get(i) != cornerIndex - 13 && indexes.get(i) != cornerIndex - 18 && indexes.get(i) != cornerIndex - 17 && indexes.get(i) != cornerIndex - 16) {
                    return false;
                }
            }
        } else {
    ...
    public boolean checkFlipLongL(int cornerIndex) {
        if (indexes.size() == 4) {
            for (int i = 0; i < indexes.size(); i++) {
                if (indexes.get(i) != cornerIndex && indexes.get(i) != cornerIndex - 5 && indexes.get(i) != cornerIndex - 3 && indexes.get(i) != cornerIndex - 4) {
                    return false;
                }
            }
        }  else {
    ...
    public boolean checkFlipLongU(int cornerIndex) {
        if (indexes.size() == 7) {
            for (int i = 0; i < indexes.size(); i++) {
                if (indexes.get(i) != cornerIndex && indexes.get(i) != cornerIndex - 5 && indexes.get(i) != cornerIndex - 10 && indexes.get(i) != cornerIndex - 11 && indexes.get(i) != cornerIndex - 12 && indexes.get(i) != cornerIndex - 2 && indexes.get(i) != cornerIndex - 7) {
                    return false;
                }
            }
        } else {
    ...
    public boolean checkFlipReverse2l(int cornerIndex) {
        if (indexes.size() == 5) {
            for (int i = 0; i < indexes.size(); i++) {
                if (indexes.get(i) != cornerIndex && indexes.get(i) != cornerIndex - 5 && indexes.get(i) != cornerIndex - 6 && indexes.get(i) != cornerIndex - 11 && indexes.get(i) != cornerIndex - 12) {
                    return false;
                }
            }
        } else if (indexes.size() == 9) {
            for (int i = 0; i < indexes.size(); i++) {
                if (indexes.get(i) != cornerIndex && indexes.get(i) != cornerIndex - 5 && indexes.get(i) != cornerIndex - 10 && indexes.get(i) != cornerIndex - 11  && indexes.get(i) != cornerIndex - 12 && indexes.get(i) != cornerIndex - 17  && indexes.get(i) != cornerIndex - 22 && indexes.get(i) != cornerIndex - 23 && indexes.get(i) != cornerIndex - 24) {
                    return false;
                }
            }
        } else {
    ...
    public boolean checkFlipReverseLongL(int cornerIndex) {
        if (indexes.size() == 4) {
            for (int i = 0; i < indexes.size(); i++) {
                if (indexes.get(i) != cornerIndex && indexes.get(i) != cornerIndex - 5 && indexes.get(i) != cornerIndex - 6 && indexes.get(i) != cornerIndex - 7) {
                    return false;
                }
            }
        } else {
    ...
    public boolean checkFlipTallL(int cornerIndex) {
        if (indexes.size() == 4) {
            for (int i = 0; i < indexes.size(); i++) {
                if (indexes.get(i) != cornerIndex && indexes.get(i) != cornerIndex - 5 && indexes.get(i) != cornerIndex - 10 && indexes.get(i) != cornerIndex - 9) {
                    return false;
                }
            }
        } else {
    ...
    public boolean checkFlipU(int cornerIndex) {
        if (indexes.size() == 5) {
            for (int i = 0; i < indexes.size(); i++) {
                if (indexes.get(i) != cornerIndex && indexes.get(i) != cornerIndex - 5 && indexes.get(i) != cornerIndex - 6 && indexes.get(i) != cornerIndex - 7 && indexes.get(i) != cornerIndex - 2) {
                    return false;
                }
            }
        } else {
    ...
    public boolean checkHorizontalLine() {
        ...
        if (!inLine1) {
            for (int i = 0; i < indexes.size(); i++) {
                if (indexes.get(i) > 9 || indexes.get(i) < 5) {
                    inLine2 = false;
                    break;
                }
            }
            if (!inLine2) {
                for (int i = 0; i < indexes.size(); i++) {
                    if (indexes.get(i) > 14 || indexes.get(i) < 10) {
                        inLine3 = false;
                        break;
                    }
                }
                if (!inLine3) {
                    for (int i = 0; i < indexes.size(); i++) {
                        if (indexes.get(i) > 19 || indexes.get(i) < 15) {
                            inLine4 = false;
                            break;
                        }
                    }
                    if (!inLine4) {
                        for (int i = 0; i < indexes.size(); i++) {
                            if (indexes.get(i) > 24 || indexes.get(i) < 20) {
                                inLine5 = false;
                                break;
                            }
                        }
        ...
        if (!inLine1 && !inLine2 && !inLine3 && !inLine4 && !inLine5) {
            return false;
        }

        for (int i = 0; i < indexes.size(); i++) {
            for (int j = 0; j < indexes.size(); j++) {
                if (Math.abs(indexes.get(i) - indexes.get(j)) >= 5) {
                    return false;
                }
            }
        }
    ...
    public boolean checkIntegral(int cornerIndex) {
        if (indexes.size() == 5) {
            for (int i = 0; i < indexes.size(); i++) {
                if (indexes.get(i) != cornerIndex && indexes.get(i) != cornerIndex - 5 && indexes.get(i) != cornerIndex - 1 && indexes.get(i) != cornerIndex - 10 && indexes.get(i) != cornerIndex - 9) {
                    return false;
                }
            }
        } else {
    ...
    public boolean checkL(int cornerIndex) {
        if (indexes.size() == 3) {
            for (int i = 0; i < indexes.size(); i++) {
                if (indexes.get(i) != cornerIndex && indexes.get(i) != cornerIndex - 1 && indexes.get(i) != cornerIndex - 6) {
                    return false;
                }
            }
        } else if (indexes.size() == 5) {
            for (int i = 0; i < indexes.size(); i++) {
                if (indexes.get(i) != cornerIndex && indexes.get(i) != cornerIndex - 1 && indexes.get(i) != cornerIndex - 2 && indexes.get(i) != cornerIndex - 7 && indexes.get(i) != cornerIndex - 12) {
                    return false;
                }
            }
        } else if (indexes.size() == 7) {
            for (int i = 0; i < indexes.size(); i++) {
                if (indexes.get(i) != cornerIndex && indexes.get(i) != cornerIndex - 1 && indexes.get(i) != cornerIndex - 2 && indexes.get(i) != cornerIndex - 3 && indexes.get(i) != cornerIndex - 8 && indexes.get(i) != cornerIndex - 13 && indexes.get(i) != cornerIndex - 18) {
                    return false;
                }
            }
        } else if (indexes.size() == 9) {
            for (int i = 0; i < indexes.size(); i++) {
                if (indexes.get(i) != cornerIndex && indexes.get(i) != cornerIndex - 1 && indexes.get(i) != cornerIndex - 2 && indexes.get(i) != cornerIndex - 3 && indexes.get(i) != cornerIndex - 4 && indexes.get(i) != cornerIndex - 9 && indexes.get(i) != cornerIndex - 14 && indexes.get(i) != cornerIndex - 19 && indexes.get(i) != cornerIndex - 24) {
                    return false;
                }
            }
        } else {
    ...
    public boolean checkLongU(int cornerIndex) {
        if (indexes.size() == 7) {
            for (int i = 0; i < indexes.size(); i++) {
                if (indexes.get(i) != cornerIndex && indexes.get(i) != cornerIndex - 1 && indexes.get(i) != cornerIndex - 2 && indexes.get(i) != cornerIndex - 7 && indexes.get(i) != cornerIndex - 12 && indexes.get(i) != cornerIndex - 5 && indexes.get(i) != cornerIndex - 10) {
                    return false;
                }
            }
        } else {
    ...
    public boolean checkReverse2l(int cornerIndex) {
        if (indexes.size() == 5) {
            for (int i = 0; i < indexes.size(); i++) {
                if (indexes.get(i) != cornerIndex && indexes.get(i) != cornerIndex - 1 && indexes.get(i) != cornerIndex - 5 && indexes.get(i) != cornerIndex - 4 && indexes.get(i) != cornerIndex - 9) {
                    return false;
                }
            }
        } else if (indexes.size() == 9) {
            for (int i = 0; i < indexes.size(); i++) {
                if (indexes.get(i) != cornerIndex && indexes.get(i) != cornerIndex - 1 && indexes.get(i) != cornerIndex - 2 && indexes.get(i) != cornerIndex - 5 && indexes.get(i) != cornerIndex - 10 && indexes.get(i) != cornerIndex - 9 && indexes.get(i) != cornerIndex - 8 && indexes.get(i) != cornerIndex - 13 && indexes.get(i) != cornerIndex - 18) {
                    return false;
                }
            }
        } else {
    ...
    public boolean checkReverseFlipTallL(int cornerIndex) {
        if (indexes.size() == 4) {
            for (int i = 0; i < indexes.size(); i++) {
                if (indexes.get(i) != cornerIndex - 5 && indexes.get(i) != cornerIndex && indexes.get(i) != cornerIndex - 10 && indexes.get(i) != cornerIndex - 11) {
                    return false;
                }
            }
        } else {
    ...
    public boolean checkReverseIntegral(int cornerIndex) {
        if (indexes.size() == 5) {
            for (int i = 0; i < indexes.size(); i++) {
                if (indexes.get(i) != cornerIndex && indexes.get(i) != cornerIndex - 1 && indexes.get(i) != cornerIndex - 6 && indexes.get(i) != cornerIndex - 11 && indexes.get(i) != cornerIndex - 12) {
                    return false;
                }
            }
        } else {
    ...
    public boolean checkReverseL(int cornerIndex) {
        if (indexes.size() == 3) {
            for (int i = 0; i < indexes.size(); i++) {
                if (indexes.get(i) != cornerIndex - 1 && indexes.get(i) != cornerIndex && indexes.get(i) != cornerIndex - 5) {
                    return false;
                }
            }
        } else if (indexes.size() == 5) {
            for (int i = 0; i < indexes.size(); i++) {
                if (indexes.get(i) != cornerIndex - 1 && indexes.get(i) != cornerIndex && indexes.get(i) != cornerIndex - 5 && indexes.get(i) != cornerIndex - 2 && indexes.get(i) != cornerIndex - 10) {
                    return false;
                }
            }
        } else if (indexes.size() == 7) {
            for (int i = 0; i < indexes.size(); i++) {
                if (indexes.get(i) != cornerIndex - 1 && indexes.get(i) != cornerIndex && indexes.get(i) != cornerIndex - 5 && indexes.get(i) != cornerIndex - 2 && indexes.get(i) != cornerIndex - 10 && indexes.get(i) != cornerIndex - 3 && indexes.get(i) != cornerIndex - 15) {
                    return false;
                }
            }
        } else if (indexes.size() == 9) {
            for (int i = 0; i < indexes.size(); i++) {
                if (indexes.get(i) != cornerIndex - 1 && indexes.get(i) != cornerIndex && indexes.get(i) != cornerIndex - 5 && indexes.get(i) != cornerIndex - 2 && indexes.get(i) != cornerIndex - 10 && indexes.get(i) != cornerIndex - 3 && indexes.get(i) != cornerIndex - 15 && indexes.get(i) != cornerIndex - 4 && indexes.get(i) != cornerIndex - 20) {
                    return false;
                }
            }
        } else {
    ...
    public boolean checkReverseLongL(int cornerIndex) {
        if (indexes.size() == 4) {
            for (int i = 0; i < indexes.size(); i++) {
                if (indexes.get(i) != cornerIndex - 1 && indexes.get(i) != cornerIndex && indexes.get(i) != cornerIndex - 2 && indexes.get(i) != cornerIndex - 5) {
                    return false;
                }
            }
        } else {
    ...
    public boolean checkReverseSideIntegral(int cornerIndex) {
        if (indexes.size() == 5) {
            for (int i = 0; i < indexes.size(); i++) {
                if (indexes.get(i) != cornerIndex && indexes.get(i) != cornerIndex - 5 && indexes.get(i) != cornerIndex - 6 && indexes.get(i) != cornerIndex - 7 && indexes.get(i) != cornerIndex - 12) {
                    return false;
                }
            }
        } else {
    ...
    public boolean checkReverseSideLongU(int cornerIndex) {
        if (indexes.size() == 7) {
            for (int i = 0; i < indexes.size(); i++) {
                if (indexes.get(i) != cornerIndex && indexes.get(i) != cornerIndex - 1 && indexes.get(i) != cornerIndex - 2 && indexes.get(i) != cornerIndex - 7 && indexes.get(i) != cornerIndex - 12 && indexes.get(i) != cornerIndex - 11 && indexes.get(i) != cornerIndex - 10) {
                    return false;
                }
            }
        } else {
    ...
    public boolean checkReverseSideU(int cornerIndex) {
        if (indexes.size() == 5) {
            for (int i = 0; i < indexes.size(); i++) {
                if (indexes.get(i) != cornerIndex - 1 && indexes.get(i) != cornerIndex - 6 && indexes.get(i) != cornerIndex - 11 && indexes.get(i) != cornerIndex - 10 && indexes.get(i) != cornerIndex) {
                    return false;
                }
            }
        } else {
    ...
    public boolean checkReverseTallL(int cornerIndex) {
        if (indexes.size() == 4) {
            for (int i = 0; i < indexes.size(); i++) {
                if (indexes.get(i) != cornerIndex - 5 && indexes.get(i) != cornerIndex && indexes.get(i) != cornerIndex - 10 && indexes.get(i) != cornerIndex - 1) {
                    return false;
                }
            }
        } else {
    ...
    public boolean checkReverseVZigZag(int cornerIndex) {
        if (indexes.size() == 4) {
            for (int i = 0; i < indexes.size(); i++) {
                if (indexes.get(i) != cornerIndex && indexes.get(i) != cornerIndex - 4 && indexes.get(i) != cornerIndex - 5 && indexes.get(i) != cornerIndex - 9) {
                    return false;
                }
            }
        } else if (indexes.size() == 7) {
            for (int i = 0; i < indexes.size(); i++) {
                if (indexes.get(i) != cornerIndex && indexes.get(i) != cornerIndex - 5 && indexes.get(i) != cornerIndex - 10 && indexes.get(i) != cornerIndex - 9 && indexes.get(i) != cornerIndex - 8 && indexes.get(i) != cornerIndex - 13 && indexes.get(i) != cornerIndex - 18) {
                    return false;
                }
            }
        } else {
    ...
    public boolean checkReverseZigZag(int cornerIndex) {
        if (indexes.size() == 4) {
            ...
            for (int i = 0; i < indexes.size(); i++) {
                if (indexes.get(i) != cornerIndex && indexes.get(i) != cornerIndex - 1 && indexes.get(i) != cornerIndex - 2 && indexes.get(i) != cornerIndex - 7 && indexes.get(i) != cornerIndex - 12 && indexes.get(i) != cornerIndex - 13 && indexes.get(i) != cornerIndex - 14) {
                    return false;
                }
            }
        } else {
    ...
    public boolean checkSideIntegral(int cornerIndex) {
        if (indexes.size() == 5) {
            for (int i = 0; i < indexes.size(); i++) {
                if (indexes.get(i) != cornerIndex && indexes.get(i) != cornerIndex - 5 && indexes.get(i) != cornerIndex - 4 && indexes.get(i) != cornerIndex - 3 && indexes.get(i) != cornerIndex - 8) {
                    return false;
                }
            }
        } else {
    ...
    public boolean checkSideLongU(int cornerIndex) {
        if (indexes.size() == 7) {
            for (int i = 0; i < indexes.size(); i++) {
                if (indexes.get(i) != cornerIndex && indexes.get(i) != cornerIndex - 1 && indexes.get(i) != cornerIndex - 2 && indexes.get(i) != cornerIndex - 5 && indexes.get(i) != cornerIndex - 10 && indexes.get(i) != cornerIndex - 11 && indexes.get(i) != cornerIndex - 12) {
                    return false;
                }
            }
        } else {
    ...
    public boolean checkSideU(int cornerIndex) {
        if (indexes.size() == 5) {
            for (int i = 0; i < indexes.size(); i++) {
                if (indexes.get(i) != cornerIndex - 1 && indexes.get(i) != cornerIndex - 5 && indexes.get(i) != cornerIndex - 10 && indexes.get(i) != cornerIndex - 11 && indexes.get(i) != cornerIndex) {
                    return false;
                }
            }
        } else {
    ...
    public boolean checkSquare(int cornerIndex) {
        if (indexes.size() == 4) {
            for (int i = 0; i < indexes.size(); i++) {
                if (indexes.get(i) != cornerIndex && indexes.get(i) != cornerIndex - 1 && indexes.get(i) != cornerIndex - 5 && indexes.get(i) != cornerIndex - 6) {
                    return false;
                }
            }
        } else if (indexes.size() == 9) {
            for (int i = 0; i < indexes.size(); i++) {
                if (indexes.get(i) != cornerIndex && indexes.get(i) != cornerIndex - 1 && indexes.get(i) != cornerIndex - 5 && indexes.get(i) != cornerIndex - 6 && indexes.get(i) != cornerIndex - 2 && indexes.get(i) != cornerIndex - 7 && indexes.get(i) != cornerIndex -12 && indexes.get(i) != cornerIndex - 11 && indexes.get(i) != cornerIndex - 10) {
                    return false;
                }
            }
    ...
    public boolean checkTallL(int cornerIndex) {
        if (indexes.size() == 4) {
            for (int i = 0; i < indexes.size(); i++) {
                if (indexes.get(i) != cornerIndex - 11 && indexes.get(i) != cornerIndex && indexes.get(i) != cornerIndex - 6 && indexes.get(i) != cornerIndex - 1) {
                    return false;
                }
            }
        } else {
    ...
    public boolean checkUPiece(int cornerIndex) {
        if (indexes.size() == 5) {
            for (int i = 0; i < indexes.size(); i++) {
                if (indexes.get(i) != cornerIndex && indexes.get(i) != cornerIndex - 5 && indexes.get(i) != cornerIndex - 1 && indexes.get(i) != cornerIndex - 7 && indexes.get(i) != cornerIndex - 2) {
                    return false;
                }
            }
        } else {
    ...
    public boolean checkVZigZag(int cornerIndex) {
        if (indexes.size() == 4) {
            for (int i = 0; i < indexes.size(); i++) {
                if (indexes.get(i) != cornerIndex && indexes.get(i) != cornerIndex - 5 && indexes.get(i) != cornerIndex - 6 && indexes.get(i) != cornerIndex - 11) {
                    return false;
                }
            }
        } else if (indexes.size() == 7) {
            for (int i = 0; i < indexes.size(); i++) {
                if (indexes.get(i) != cornerIndex && indexes.get(i) != cornerIndex - 5 && indexes.get(i) != cornerIndex - 10 && indexes.get(i) != cornerIndex - 11 && indexes.get(i) != cornerIndex - 12 && indexes.get(i) != cornerIndex - 17 && indexes.get(i) != cornerIndex - 22) {
                    return false;
                }
            }
        } else {
    ...
    public boolean checkVerticalLine(int cornerIndex) {
        if (indexes.size() < 2 || indexes.size() > 5) {
            return false;
        }
        for (int i = 0; i < indexes.size(); i++) {
            if (indexes.get(i) != cornerIndex && indexes.get(i) != cornerIndex - 5 && indexes.get(i) != cornerIndex - 10 && indexes.get(i) != cornerIndex - 15 && indexes.get(i) != cornerIndex - 20) {
                return false;
            }
        }
        return true;
    ...
    public boolean checkZigzag(int cornerIndex) {
        if (indexes.size() == 4) {
            for (int i = 0; i < indexes.size(); i++) {
                if (indexes.get(i) != cornerIndex - 1 && indexes.get(i) != cornerIndex && indexes.get(i) != cornerIndex - 5 && indexes.get(i) != cornerIndex - 4) {
                    return false;
                }
            }
        } else if (indexes.size() == 7) {
            for (int i = 0; i < indexes.size(); i++) {
                if (indexes.get(i) != cornerIndex - 1 && indexes.get(i) != cornerIndex && indexes.get(i) != cornerIndex - 5 && indexes.get(i) != cornerIndex - 2 && indexes.get(i) != cornerIndex - 10 && indexes.get(i) != cornerIndex - 9 && indexes.get(i) != cornerIndex - 8) {
                    return false;
                }
            }
        } else {
    ...
    public boolean onLongClick(View view) {
        ...
        } else if (view.getId() == R.id.clear5) {
            filled.clear();
            Arrays.fill(colorsDone, -1);
            for (int i = 0; i < ivList.size(); i++) {
                ivList.get(i).setImageResource(R.drawable.blank6);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.menu_in_game_five, menu);
        return true;
    }
    ...
    private void initialize() {
        ...
        iv5 = (ImageView) findViewById(R.id.i01);
        iv6 = (ImageView) findViewById(R.id.i11);
        iv7 = (ImageView) findViewById(R.id.i21);
        iv8 = (ImageView) findViewById(R.id.i31);
        iv9 = (ImageView) findViewById(R.id.i41);
        iv10 = (ImageView) findViewById(R.id.i02);
        iv11 = (ImageView) findViewById(R.id.i12);
        iv12 = (ImageView) findViewById(R.id.i22);
        iv13 = (ImageView) findViewById(R.id.i32);
        iv14 = (ImageView) findViewById(R.id.i42);
        iv15 = (ImageView) findViewById(R.id.i03);
        iv16 = (ImageView) findViewById(R.id.i13);
        iv17 = (ImageView) findViewById(R.id.i23);
        iv18 = (ImageView) findViewById(R.id.i33);
        iv19 = (ImageView) findViewById(R.id.i43);
        iv20 = (ImageView) findViewById(R.id.i04);
        iv21 = (ImageView) findViewById(R.id.i14);
        iv22 = (ImageView) findViewById(R.id.i24);
        iv23 = (ImageView) findViewById(R.id.i34);
        iv24 = (ImageView) findViewById(R.id.i44);

        ImageView[] ivArray = {iv0, iv1, iv2, iv3, iv4, iv5, iv6, iv7, iv8, iv9, iv10, iv11, iv12, iv13, iv14, iv15, iv16, iv17, iv18, iv19, iv20, iv21, iv22, iv23, iv24};
        ivList.addAll(Arrays.asList(ivArray));

        ivPieces = new ArrayList<>();
        ImageView[] ivPiecesArray = {piece1, piece2, piece3, piece4, piece5, piece6, piece7, piece8, piece9, piece10};
    ...
    public void resetPieces() {
        ...
        for (int i = 0; i < numNotDone; i++) {
            ivPieces.get(9 - i).setVisibility(View.GONE);
        }
    }

    @Override
    public void onBackPressed() {
        Intent newIntent = new Intent(this, SelectFive.class);
        startActivity(newIntent);
    }
}
